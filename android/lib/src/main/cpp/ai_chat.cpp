 ...
 */
// ZeroCloudAssist: valores del plan 01 para el A53 (8 núcleos -> min(6, 8 - 2) = 6 hilos,
// el óptimo medido en el informe 2026-09-13). El ejemplo traía 4 hilos, 8192 y 0.3.
...
Java_com_arm_aichat_internal_InferenceEngineImpl_processUserPrompt(
    ...
    // ZeroCloudAssist: el ejemplo sumaba user_prompt_size otra vez (ya está en current_position),
